...
public class NodeP2PGui extends javax.swing.JFrame implements P2Plistener {
    ...
    public NodeP2PGui() {
        initComponents();
        txtServerListeningObjectName.setText(OremoteP2P.REMOTE_OBJECT_NAME);
        setRandomPosition();
    ...
    private void btStartServerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btStartServerActionPerformed
        try {
            ...
            String name = OremoteP2P.REMOTE_OBJECT_NAME;
            myremoteObject = new OremoteP2P(port, this);
    ...
    public void onConect(String address) {
        try {
            GuiUtils.addText(txtServerLog, "Conected to", address);
            List<IremoteP2P> net = myremoteObject.getNetwork();
            txtNetwork.setText("");
            for (IremoteP2P iremoteP2P : net) {
                txtNetwork.append(iremoteP2P.getAdress() + "\n");
            }
